...
public interface RunQualityReportService {
    //查询延误分析
    ...
    //查询小时架次统计图
    List<RunQualityReportEChartVo> findEChartsInfo(@Param("params") Map params);
    ...
    //机场运量统计
    List<RunQualityReportYLTJVo> findYunLiangTJInfo(@Param("params") Map params);

    //航班正常性统计
    List<RunQualityReportYLTJVo> findHBZCXTJInfo(@Param("params") Map params);

    //延误原因统计
    List<RunQualityReportYWYYVo> findYWYYTJInfo(@Param("params") Map params);

    //航班进程质量管控
    List<RunQualityReportJCZLJGVo> findHBJCZLJGInfo(@Param("params") Map params);

    //放行正常率排名
    List<RunQualityReportFXZCLPMVo> findFXZCLPMInfo(@Param("params") Map params);

    //航班正常管理提示
    List<RunQualityReportTipsVo> findFltManageTipsInfo(@Param("params") Map params);
