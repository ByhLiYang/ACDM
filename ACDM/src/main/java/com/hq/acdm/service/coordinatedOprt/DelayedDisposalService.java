 ...
 * @Description
 */
public interface DelayedDisposalService {
    //查询取消航班
    ...
    //查询取消酒店
    Map<String,Object> findholInfo(@Param("params") Map params);
    //查询取消巴士
    Map<String,Object> findbusInfo(@Param("params") Map params);

    //删除酒店
    int deleteHolByPrimaryKey(String id);
    //根据外键删除酒店
