...
public class TBelt implements Serializable {
    ...
    public void setExitNo(String exitNo) {
        this.exitNo = exitNo == null ? null : exitNo.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getExitNo() == null ? other.getExitNo() == null : this.getExitNo().equals(other.getExitNo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getExitNo() == null) ? 0 : getExitNo().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", exitNo=").append(exitNo);
