...
public class TFlightStatus implements Serializable {
    ...
    public String getIsNormalState() {
        return isNormalState;
    }

    public void setIsNormalState(String isNormalState) {
        this.isNormalState = isNormalState == null ? null : isNormalState.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TFlightStatus other = (TFlightStatus) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIsNormalState() == null ? other.getIsNormalState() == null : this.getIsNormalState().equals(other.getIsNormalState()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsNormalState() == null) ? 0 : getIsNormalState().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", isNormalState=").append(isNormalState);
